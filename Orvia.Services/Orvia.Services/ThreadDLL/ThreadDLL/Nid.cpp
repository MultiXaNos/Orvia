	...
	std::string _pathDebugFile)
{
	...
	periphBalance = new PeriphBalance(_port, _baud, _nbDataBits, _parity, _nbStopBits, _SNBalance, _debug, _pathDebugFile );
	periphRFID    = new PeriphRFID(   _port, _baud, _nbDataBits, _parity, _nbStopBits, _SNAntenne, _debug, _pathDebugFile );
