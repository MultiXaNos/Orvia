						...
						std::string _pathDebugFile		)
{
	...
	if (debugMode == 1) {
		...
		snprintf(buffer, STR_SIZE, "|CONSTRUCTION| ThreadNid deviceBalance : %s, deviceRFID : %s, baudrate : %i, nbDataBits : %i, parity : %i, nbStopBits : %i, SN Balance : %s, SN RFID : %s, Min poids oeuf : %f, Max poids oeuf : %f, Min poids poule : %f, Max poids poule : %f", 
